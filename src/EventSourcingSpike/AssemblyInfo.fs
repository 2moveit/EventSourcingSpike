...
[<assembly: AssemblyTitleAttribute("EventSourcingSpike")>]
[<assembly: AssemblyProductAttribute("EventSourcingSpike")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "EventSourcingSpike"
    let [<Literal>] AssemblyProduct = "EventSourcingSpike"
