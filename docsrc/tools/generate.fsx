...
let website = "/EventSourcingSpike"

let githubLink = "https://github.com/2moveit/EventSourcingSpike"

// Specify more information about your project
let info =
  [ "project-name", "EventSourcingSpike"
    "project-author", "Update Author in build.fsx"
    "project-summary", "Project has no summmary; update build.fsx"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/EventSourcingSpike" ]
